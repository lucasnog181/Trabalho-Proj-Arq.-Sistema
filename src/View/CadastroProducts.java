...
public class CadastroProducts extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CadastroProducts frame = new CadastroProducts();
	...
	public CadastroProducts() {
		...
		lblNewLabel_3.setBounds(1322, 0, 46, 87);
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				} else if (textFieldTipoValor.getText().isEmpty()) {
					JOptionPane.showMessageDialog(null, "O codigo do produto não pode ser Vazio !");
				} else if (textFieldValorProduto.getText().isEmpty()) {
					JOptionPane.showMessageDialog(null, "O codigo do produto não pode ser Vazio !");
				} else {
					adicionarProduto();
					JOptionPane.showMessageDialog(null, "Produto Cadastrado com sucesso !");
					System.out.println("Produto " + textFieldNome.getText() + " cadastrado com sucesso!");
	...
	public void adicionarProduto() {
		try {
			...
			Produto produto = new Produto.ProdutoBuilder().codigo_produto(55).nome_produto(textFieldNome.getText())
					.valor_produto(textFieldValorProduto.getText()).tipo_produto(textFieldTipoValor.getText())
					.descricao_produto(textFieldDescricao.getText()).criarProduto();

			ProdutoControllers.salvar(produto);
